									...
									.addActionListener(new ActionListener() {
										...
										public void actionPerformed(
											...
											try {
												...
												System.out.println(" GettingNifty: The 'USE database' syntax no longer works with the addition of"
														           + "\n SwingWorker or because I changed aws database regions. AWS also uses"
														           + "\n an XML file strategy for database connectivity that I will be looking"
														           + "\n into as I may be able to zip lock the file, hiding the log in"
														           + "\n information from the source code, which can be decompiled by hackers. "
														           + "\n There is also a way to do it with a properties file. I have Swing"
														           + "\n configured with a DataSource method in the SwingWorker so the XML"
														           + "\n implementation should probably follow allong those lines or similiar.");
...

			{
				...
				newButton.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent evt) {
						...
						JFrame newFrame = new JFrame("Welcome to Heavy Evil, Please choose an account.");
