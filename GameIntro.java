...
public class GameIntro extends JFrame implements GLEventListener {
	...
	public void display(GLAutoDrawable draw) {
		...
		gl.glRotated(rpoly, -0.2d, -2/7.4 * Math.PI, -0.135);
		gl.glTranslated(-60, -10, 00);
        gl.glPushMatrix();
		glut.glutWireSphere(20, 110, 20);
		gl.glPopMatrix();
		...
		gl.glLightfv(GL2.GL_LIGHT1, GL2.GL_AMBIENT, ambientLight, 1);

		float[] diffuseLight = { 0f, 2.3f, 1f, 0f };
		gl.glLightfv(GL2.GL_LIGHT1, GL2.GL_2_BYTES, diffuseLight, 1);
	...
	public void reshape(GLAutoDrawable draw, int y, int x, int width, int height) {
		...
		glu.gluLookAt(0, 0, 0, 55, 0, 0, 0, 0, 0);
