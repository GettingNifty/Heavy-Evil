...
public class GameIntro extends JFrame implements GLEventListener {
	...
	public void display(GLAutoDrawable draw) {
		...
		gl.glColor3f(0.33f, 0.33f, 0f);

		// Clear The Screen And The Depth Buffer
		gl.glClear(GL2.GL_COLOR_BUFFER_BIT | GL2.GL_DEPTH_BUFFER_BIT);
		gl.glLoadIdentity(); // Reset The View
		gl.glScaled(1.d, 1.d, 0.d);
		...
		float[] ambientLight = { 3.1f, 1.f, 1.f, 0f };
		gl.glLightfv(GL2.GL_LIGHT1, GL2.GL_AMBIENT, ambientLight, 3);

		float[] diffuseLight = { 1f, 1f, 7f, 0f };
		gl.glLightfv(GL2.GL_LIGHT0, GL2.GL_DIFFUSE, diffuseLight, 2);
