...
public class ObjectInteractive extends Frame {
	 ...
	 * ENTER TO CYCLE, UNLESS IT PROVIDES YOU WITH ARROW KEYS eg.
	 * 
	 * o gargoyle <------wrong
	 * 
	 * # o gargoyle <------right
	...
	TransformGroup getGargoyle(Scene modelSceneI) {
		...
		transforms.setTranslation(scale);
	...
	void enableTransformCapability(TransformGroup... gargoyle) {
		for (TransformGroup parts : gargoyle) {
			parts.setCapability(TransformGroup.ALLOW_TRANSFORM_WRITE);
