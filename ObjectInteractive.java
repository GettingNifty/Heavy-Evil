...
public class ObjectInteractive extends Frame {
	...
	TransformGroup getGargoyle(Scene scene1) {
		...
		Map<String, Shape3D> nameMap = new Hashtable<String, Shape3D>();
		scene1.getNamedObjects();

		Set<String> name = nameMap.keySet();
		name.getClass();
		...
		viewTransformI.getTransform(t3dI);
		...
		enableTransformCapability(teeth, wings, gargoyle);
