...

{
		...
		transforms.lookAt(new Point3d(0, 0, 4), new Point3d(0, 0, 0), new Vector3d(0,
				1, 0));
		transforms.invert();
		...
		Vector3d scale = new Vector3d(1D, 1D, 2D);
		...
		RotPosPathInterpolator rotPosPath = new RotPosPathInterpolator(
				alphaNave, wings, transforms, alphas, quats, positions);
		...
		viewTransformI.setTransform(transforms);
