...
public class ObjectInteractive extends Frame {
	...
	public ObjectInteractive() {
		 ...
		 * BLENDER, JAVA3D REQUIRES YOU TO OPEN THE OBJECT IN A TEXT EDITOR
		 * AND ADD "#" IN FRONT OF EVERY OBJECT "o". COMMAND F TO SEARCH FOR
		 * TEXT "o" AND ENTER TO CYCLE, UNLESS IT PROVIDES YOU WITH ARROW KEYS
		 * eg.
		 * 
		 * o gargoyle    <------wrong
		 * 
		...
		root.addChild(viewPlatformI);
		viewPlatformI.addChild(modelI);
		...
		eyes.addChild(nameMap.get("eyes"));
