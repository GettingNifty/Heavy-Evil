...
public class ObjectInteractive extends Frame {
	...
	public ObjectInteractive() {
		...
		try {
			sceneI = loaderI.load("Images/untitled.obj");
			modelI = (Shape3D) sceneI.getSceneGroup().getChild(0);
			sceneI.getSceneGroup().removeChild(0);
		...
		root.addChild(sceneI.getSceneGroup());
		...
		viewTransformI.addChild(viewPlatformI);
